...
nft add set inet test_tbl testset2s { type ipv4_addr \; flags timeout, interval \; auto-merge \; }

nft add set inet test_tbl blacklist { type ipv4_addr \; flags timeout, interval \; auto-merge \; }
